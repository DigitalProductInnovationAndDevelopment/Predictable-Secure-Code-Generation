...
def test_handle_user_choice_valid_operations(
    mock_calculator, choice, inputs, expected_output, capsys
):
    """
...
def test_handle_user_choice_invalid_numeric_input(
    mock_calculator, choice, inputs, capsys
):
    """
